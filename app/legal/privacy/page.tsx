      ...
      <div className="space-y-6">
        <SectionCard id="overview" title="01. Overview">
          <p>
            ...
            <a href="mailto:support.autoengage@gmail.com" className="underline hover:text-zinc-900 dark:hover:text-white">
        ...
        <SectionCard id="your-rights" title="06. Your Rights">
          ...
          <p className="mt-4">
            ...
            <a href="mailto:support.autoengage@gmail.com" className="text-zinc-800 dark:text-zinc-200 underline hover:text-zinc-900 dark:hover:text-white">
              support.autoengage@gmail.com
            </a>{' '}
        ...
        <SectionCard id="children" title="08. Children's Privacy">
          <p>
            ...
            data, please contact{' '}
            <a href="mailto:support.autoengage@gmail.com" className="underline hover:text-white">
              support.autoengage@gmail.com
            </a>{' '}
        ...
        <SectionCard id="contact" title="10. Contact Us">
          ...
          >
            ...
            <p>
              ...
              <a href="mailto:support.autoengage@gmail.com" className="text-zinc-800 dark:text-zinc-300 underline hover:text-zinc-950 dark:hover:text-white font-medium">
                support.autoengage@gmail.com
              </a>
            </p>
            <p>
