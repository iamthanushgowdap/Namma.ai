...
export const metadata: Metadata = {
  title: 'Data Deletion Instructions | Namma.ai',
  description: 'Instructions on how to request the deletion of your personal data and unlink your Instagram account from Namma.ai.',
}
      ...
      <div className="space-y-8">
        ...
        <section className="glass-panel border border-zinc-200 dark:border-zinc-800/80 rounded-2xl p-6">
          ...
          <p className="text-zinc-500 dark:text-zinc-400 text-xs sm:text-sm leading-relaxed mb-4">
            You can remove the Namma.ai integration directly from your Meta settings. This instantly revokes all permissions and prevents our platform from receiving future events.
          </p>
          <ol className="list-decimal list-inside text-xs sm:text-sm text-zinc-650 dark:text-zinc-400 space-y-2">
            ...
            <li>Find <strong>Namma.ai</strong> in the list of active applications.</li>
            <li>Click the <strong>Remove</strong> button next to the Namma.ai entry.</li>
        ...
        <section className="glass-panel border border-zinc-200 dark:border-zinc-800/80 rounded-2xl p-6">
          ...
          <ol className="list-decimal list-inside text-xs sm:text-sm text-zinc-650 dark:text-zinc-400 space-y-2">
            <li>Log into your Namma.ai dashboard at <a href="https://namma.ai/login" className="text-indigo-600 dark:text-indigo-400 hover:underline">namma.ai/login</a>.</li>
        ...
        <section className="glass-panel border border-zinc-200 dark:border-zinc-800/80 rounded-2xl p-6">
          ...
          <p className="text-zinc-500 dark:text-zinc-400 text-xs sm:text-sm leading-relaxed mb-3">
            Please write to us at <a href="mailto:contact@namma.ai" className="text-indigo-600 dark:text-indigo-400 hover:underline">contact@namma.ai</a> with the subject line <strong>&quot;Data Deletion Request&quot;</strong>.
          </p>
